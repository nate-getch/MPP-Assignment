...
public class ProcessingEmployees1
{
   public static void main(String[] args)
   {
      ...
      */
      ...
      list.stream()
      	  .filter(t->t.getSalary() >= 4000 && t.getSalary() <= 6000  )
      	  .map(t -> t.getSalary() + " " + t.getFirstName())
         .sorted()
      ...
      MyInterface<String, String, Double,String, Employee > myInterfaceObj = Employee::new;
      System.out.println(myInterfaceObj.apply("nati", "getch", 7000.0, "IT"));
    ...
    * Java function-type interface [3 Points] */   
   		...
   		/*	List<String> l2 = list.stream()
   			...
   			*/
      System.out.println(MyLambdaLib.EmployeeFilterWithLastName.apply(list, "I"));
